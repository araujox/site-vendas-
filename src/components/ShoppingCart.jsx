        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-border">
              ...
              <Button onClick={() => setIsCartOpen(false)} variant="ghost" size="icon" className="text-card-foreground hover:bg-muted" aria-label="Fechar carrinho">
                <X />
              </Button>
            </div>
                  ...
                  <div key={item.variant.id} className="flex items-center gap-4 bg-card border border-border p-3 rounded-lg">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      <div className="flex items-center border border-border rounded-md">
                        <Button onClick={() => updateQuantity(item.variant.id, Math.max(1, item.quantity - 1))} size="sm" variant="ghost" className="px-2 text-card-foreground hover:bg-muted" aria-label="Diminuir quantidade">-</Button>
                        <span className="px-2 text-card-foreground" aria-label="Quantidade atual">{item.quantity}</span>
                        <Button onClick={() => updateQuantity(item.variant.id, item.quantity + 1)} size="sm" variant="ghost" className="px-2 text-card-foreground hover:bg-muted" aria-label="Aumentar quantidade">+</Button>
                      </div>
